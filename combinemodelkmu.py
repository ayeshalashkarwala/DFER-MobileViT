...
from models.gcvit import DFER_GCVIT
from models.mobilevit import DFER_MobileViT
from KMU import KMU
...
transforms_vaild = torchvision.transforms.Compose([
                                     ...
                                     torchvision.transforms.Resize((256,256)), # origionally 224 by 224
...
elif opt.model == 'gcvit':
   num_classes = 6  
   net = DFER_GCVIT(num_classes=num_classes, pretrained=True)
elif opt.model == 'mobilevit':
    num_classes = 6
    net = DFER_MobileViT(num_classes=num_classes, pretrained=True)
else:
   raise ValueError(f"Unknown model: {opt.model}. Choose 'Ourmodel' or 'gcvit'") 
